---
title: "Guide: Intro to Web Scraping"
author: ~
date: '2017-11-18'
output:
  blogdown::html_page:
...
knitr::include_graphics('/images/web_scrape_guide/img1.png')
```
...
```{r, out.width =  '80%', echo=F}
knitr::include_graphics('/images/web_scrape_guide/highlighted_tag.png')
```
